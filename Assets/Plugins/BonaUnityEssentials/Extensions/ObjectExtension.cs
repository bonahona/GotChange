...
public static class ObjectExtension
{
    ...
    public static T GetInterface<T>(this UnityEngine.Object o)
    {
        if(o is Component) {
            ...
            return o.To<GameObject>().GetGameObjectInterface<T>();
    ...
    public static T GetGameObjectInterface<T>(this UnityEngine.GameObject gameObject)
    {
        foreach(var component in gameObject.transform.GetComponents<Component>()) {
            var result = component.GetComponentInterface<T>();
            if(result != null) {
                return result;
            }
        }
